# SecureAuthX Pro — Documentation

Enterprise Multi-Factor Authentication Platform. Self-hosted, open source,
and built on open standards.

## Contents

- [Getting Started](./getting-started.md) — local development setup
- [Architecture](./architecture.md) — system design, monorepo layout, data model
